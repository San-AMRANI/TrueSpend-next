    ...
    <div className={styles.layout}>
      ...
      <aside className={styles.sidebar}>
        ...
        <nav className={styles.sidebarNav}>
          ...
          <Link href="/dashboard/transactions" className={styles.navLink}>📝 Transactions</Link>
          <Link href="/dashboard/debts" className={styles.navLink}>🤝 Debts</Link>
          <Link href="/dashboard/settings" className={styles.navLink}>⚙️ Settings</Link>
        </nav>
